...
function renderPreview() {
    ...
    let itemsHtml = items.map(item => {
        ...
        let wrapperStyle = `display: inline-block; width: ${w}px; vertical-align: top; text-align: center; margin-bottom: 40px; box-sizing: border-box; padding-left: 15px; padding-right: 15px;`;
        ...
        <div style="background-color: #f6f9fc; width: 100%; min-height: 100%; padding: 40px 0; font-family: 'Atkinson Hyperlegible', 'Helvetica Neue', Helvetica, Arial, sans-serif;">
            <center>
                <div style="width: ${viewMode==='mobile'?'100%':'600px'}; background-color: #ffffff; text-align: center; border-radius: 8px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
                    ...
                    <!-- Footer -->
                    <div style="background-color: #f3f4f6; padding: 30px; border-top: 1px solid #e5e7eb;">
                        <p style="color: #9ca3af; font-size: 12px; margin:0; line-height: 18px;">${state.footerText}<br><a href="#" style="color:#6b7280; text-decoration: underline;">Se désinscrire</a></p>
                    </div>
                </div>
            </center>
        </div>
...
async function copyHTML() {
    ...
    try {
        ...
        btn.innerHTML = `<i data-lucide="alert-triangle" class="w-4 h-4"></i> Manuel`;
    }
...
function generateEmailString(items) {
    const rows = items.map(item => {
        ...
        return `
        <!-- BLOC ${item.title} -->
        <div class="responsive-col" style="display: inline-block; width: ${w}px; vertical-align: top; text-align: center; margin-bottom: 40px; box-sizing: border-box; padding-left: 15px; padding-right: 15px; ${borderRight}">
            ...
            <tr>
                <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" width="600" class="main-container" style="background-color: #ffffff; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); border-radius: 8px;">
                        ...
                        <tr>
                            <td align="center" style="background-color: #f3f4f6; padding: 30px; border-top: 1px solid #e5e7eb;">
